...
local styles_home = home .. '.config/nvim/styles/'
...
local on_attach = function(client, bufnr)
  ...
  nnoremap('gh', vim.lsp.buf.implementation, bufopts, "Go to implementation")
    ...
    java = {
      format = {
        settings = {
          ...
          url = styles_home .. "eclipse-java-google-style.xml",
          profile = "GoogleStyle",
        },
      },
